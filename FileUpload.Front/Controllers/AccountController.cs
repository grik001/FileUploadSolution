...
namespace FileUpload.Front.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IAspNetUserDataModel aspNetUserDataModel)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    {
                        var user = _aspNetUserDataModel.Get(model.Email);
                        this.Response.Cookies.Add(new HttpCookie("UserID", user.Id));
